        ...
        <div className="flex min-h-screen items-center justify-center p-4">
            <div className="w-full max-w-md card">
                <div className="text-center mb-6">
                    <h1 className="text-3xl font-bold text-[var(--primary)] mb-2">Join Rocket 🚀</h1>
                    <p className="text-[var(--text-secondary)]">새로운 가족 구성원 등록</p>
                </div>
                ...
                <div className="mt-4 text-center text-sm text-[var(--text-secondary)]">
                    이미 계정이 있으신가요? <Link href="/auth/login" className="text-[var(--primary)] font-bold hover:underline">로그인</Link>
                </div>
            </div>
        </div>
    );
