...
const ProductSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].Schema({
    ...
    price: {
        ...
        required: [
            true,
            'Please provide a price (points).'
        ],
        min: 0
    },
    image: {
        type: String,
        default: '/images/boilerplate-product.png'
    },
    stock: {
        type: Number,
        default: 1,
...
async function GET() {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
    try {
        const products = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).sort({
            createdAt: -1
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8e8ff7bb._.js.map